<x-layout>
    ...
    <div class="container mx-auto my-12">
        <div class="flex flex-col md:flex-row">
            <div class="mr-6">
                <img id="preview" src="{{ asset('storage/images/' . $produit->image) }}" alt="Image 1"
                    class="rounded mb-3 w-28 border-2 border-primary opacity-60" />
                <img id="preview" src="https://placeimg.com/112/112/arch" alt="Image 2" class="rounded mb-3 w-28" />
                <img id="preview" src="https://placeimg.com/112/112/arch" alt="Image 3" class="rounded mb-3 w-28" />
            </div>
            <div class="w-full md:w-1/2">
                <img id="fullPreview" class="rounded-2xl w-max" src="{{ asset('storage/images/' . $produit->image) }}"
                    alt="{{ $produit->image }}" alt="{{ $produit->image }}" />
            </div>
            <div class="w-full md:w-1/2">
                ...
                <p class="text-xl mb-12">{{ $produit->description }}</p>
                <p class="text-3xl font-bold">{{ $produit->getFormattedPrice() }}</p>
            ...
            {{-- <div class="w-full md:w-1/2">
                ...
                <p class="text-xl mb-12">{{ $produit->materiaux }}</p>
                <h1 class="text-4xl font-bold">
                    Dimensions
                </h1>
